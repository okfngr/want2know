...
(function($){
	$.cookieBar = function(options,val){
		...
		var defaults = {
			message: 'Για την καλύτερη εμπειρία του χρήστη, εγκαθιστούμε cookies στον υπολογιστή σας κατά την πλοήγηση.', //Message displayed on bar
			acceptButton: true, //Set to true to show accept/enable button
			acceptText: 'Καταλαβαίνω', //Text on accept/enable button
		...
		var cookieEntry = 'cb-enabled={value}; expires={expire}; path=/'
